...
Audience: Individuals evaluating a local work-execution workspace. Useful action: Read the existing workflow and public product limitations.

## Sources and publication

- Canonical publication: https://wooolfmesh.github.io/
...
- Published directory: `.`.
- Build evidence: `scripts/build-site.mjs; GitHub Pages API: main:/`.
...
Maintain the existing local-first product description and evidence boundaries; portfolio investment remains on hold.
